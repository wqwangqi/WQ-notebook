var utils = (function () {
    ...
    * */
    function setCss(ele, attr, value) {
        //box  width  100  有单位
        //box  opacity  0.5   没有单位
        //进行筛选  width height font-size   margin padding  border  left right ...
        var reg = /^width|height|fonts-size|(margin|padding)?(left|right|top|bottom)|(margin|padding)?$/i;
        //判断传进来的属性是否是正则匹配的属性，如果匹配，判断一下要设置的属性值是否带有单位，决定是或否给其添加单位
        if (reg.test(attr)){
